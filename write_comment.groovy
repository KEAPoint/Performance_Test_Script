...
class TestRunner {
	...
	public void test() {
		// Set parameters (DTO)
		params.put("postId", "be247dd5-fd2b-48e1-8319-3b5c41ae398b")
		params.put("content", "test comment")
		...
		// Send POST request
		HTTPResponse response = request.POST("http://172.16.213.23:8080/post/comments", byteParams)
